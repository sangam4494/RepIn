...
public class CreateLeadsTest extends BaseTest {
	...
	public void verify() throws Throwable {
		...
		wlib.verify(wlib.getPageTitle(), flib.readPropertyData(PROP_PATH, "leadsTab"), "create lead");
		
		CustomViewPage cv=new CustomViewPage();
		cv.clicknewleadsBtn();
		
		wlib.verify(wlib.getPageTitle(), flib.readPropertyData(PROP_PATH, "createlead"), "create lead page");
