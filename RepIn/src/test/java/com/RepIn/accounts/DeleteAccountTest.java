...
import com.RepIn.pages.DeleteAccountPage;
...
public class DeleteAccountTest extends BaseTest{
	...
	public void verify() throws Throwable {
		...
		wlib.verify(wlib.getPageTitle(), flib.readPropertyData(PROP_PATH, "accountDetails"), "Account Details Page");
	    EditAccountDetailsPage ed=new EditAccountDetailsPage();
	     ...
	     ea.accountnametB(flib.readExcelDate(EXCEL_PATH, "CreatAccount", 1, 0));
	     
	     wlib.verify(wlib.getPageTitle(), flib.readPropertyData(PROP_PATH, "accountDetails"), "Account Details");
